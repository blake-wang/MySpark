...
import base.集合框架.Demo03_ListIterator;
 ...
 * <p>
 * 注意：打印某个对象的引用，只要不是@hashcode这样的，就说明这个类重写的object的toString方法
 */
public class ObjectDemo {
    public static void main(String[] args) {
        ...
        //hashCode   -->调用对象的hashCode，返回的是对象的内存地址值，十进制的
        Demo03_ListIterator d1 = new Demo03_ListIterator();
        Demo03_ListIterator d2 = new Demo03_ListIterator();
//        Demo03_ListIterator d2 = d1;
