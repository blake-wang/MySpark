...
public class Cart {
    ...
    * 修改购物车中的商品*/
    public void updateProduct2Cart(String userName, String productId, int num) {
        mJedis.hincrBy("shop:cart:" + userName, productId, num);
    }

    /*获取用户购物车的商品信息*/
    public List<Product> getProductsByUserName(String userName) {
        List<Product>       products   = new ArrayList<Product>();
        Map<String, String> productMap = mJedis.hgetAll("shop:cart:" + userName);
        ...
        for (Map.Entry entry : productMap.entrySet()) {
            ...
            product.setNum(num > 0
                           ? num
                           : 0);//如果商品数量大于0，返回正常的值，如果商品小于0，初始化为0
    ...
    private void complementOtherField(Product product) {
        ...
        String  productJsonStr = mJedis.get("shop:product:" + productId);
    ...
    private static void initData() {
        ...
        //准备数据
        Product product1 = new Product("1645139266",
                                       "战地鳄2015秋冬新款马甲可脱卸帽休闲时尚无袖男士羽绒棉外套马甲",
                                       new BigDecimal("168"));
        Product product2 = new Product("1788744384",
                                       "天乐时 爸爸装加厚马甲秋冬装中年大码男士加绒马夹中老年坎肩老年人",
                                       new BigDecimal("40"));
        Product product3 = new Product("1645080454",
                                       "战地鳄2015秋冬新款马甲可脱卸帽休闲时尚无袖男士羽绒棉外套马甲",
                                       new BigDecimal("230"));
        ...
        //打印所有产品信息
        Set<String> allProductKeys = jedis.keys("shop:product:*");//获取所有的商品信息  --这里用的*，企业是禁止这样用的，这个写法非常消耗性能
