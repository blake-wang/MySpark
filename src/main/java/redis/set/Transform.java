...
public class Transform {
    public static void main(String[] args) {
        ...
        Long viewUserNum = jedis.scard("viewUsers");
        //        System.out.println(viewUserNum.doubleValue());    //把Long转化成double再进行小数计算
        Long orderUserNum = jedis.scard("view2order");
        //        System.out.println(orderUserNum);
        NumberFormat formatter = new DecimalFormat("0.00");
        Double       x         = new Double(orderUserNum.doubleValue() / viewUserNum.doubleValue());
        ...
        System.out.print("支付" + paymentUserNum + "/订单" + orderUserNum.doubleValue() + "  转化：" + formatter.format(
                x) + "     他们是：");
